...
class RoleController extends BaseController
{
    ...
    public function getEdit(Request $request ,$id)
    {
        ...
        if (1 == $id) {
            return redirect()->route('admin.user-group')->with('flashMessageWarning', 'You can not edit super admin role !');
        }
        $data['role']   = $this->role->findOrThrowException($id);
        $data['groups'] = $this->role->getAllGroups();
