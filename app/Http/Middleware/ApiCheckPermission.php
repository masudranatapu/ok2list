...
class ApiCheckPermission
{
    ...
    public function handle($request, Closure $next, $permission = null)
    {
        ...
        if ($access_token == '') {
            ...
            $this->response['error'] = get_error_response(400, "You didn't sent token with request");
        ...
        $this->response['error'] = get_error_response(401, "Your provided token is not valid");
        return response($this->response, 200);
    }
}
