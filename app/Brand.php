...
class Brand extends Model
{
    ...
    public function productModel() {
        return $this->hasMany('App\ProductModel', 'F_PRD_BRAND_NO')->orderBy('NAME','ASC');
    }

    public function productColor() {
        return $this->hasMany('App\Color', 'F_BRAND')->orderBy('NAME','ASC');
    }
    public function productSize() {
        return $this->hasMany('App\ProductSize', 'F_BRAND_NO')->orderBy('NAME','ASC');
    }
