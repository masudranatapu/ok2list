...
!function(e) {
    e.fn.imageUploader=function(t) {
        let n,
        i= {
            preloaded: [], imagesInputName:"image", preloadedInputName:"preloaded", label:"Drag & Drop files here or click to browse", extensions:[".jpg", ".jpeg", ".png", ".gif", ".svg"], mimes:["image/jpeg", "image/png", "image/gif", "image/svg+xml"], maxSize:void 0, maxFiles:void 0
        }
        ,
        a=this,
        s=new DataTransfer;
        ...
        a.init=function() {
            ...
            a.each(function(t, n) {
                ...
                if(e(n).append(i), i.on("dragover", r.bind(i)), i.on("dragleave", r.bind(i)), i.on("drop", p.bind(i)), a.settings.preloaded.length) {
                    ...
                    t++)e.append(l(a.settings.preloaded[t].src, a.settings.preloaded[t].id,  !0))
                }
            }
            )
        }
        ...
        let o=function() {
            ...
            n=e("<input>", {
                type: "file", id:a.settings.imagesInputName+"-"+h(), name:a.settings.imagesInputName+"[]", accept:a.settings.extensions.join(","), multiple:""
            }
            ).appendTo(t);
            e("<div>", {
                class: "uploaded"
        ...
        l=function(t, i, o) {
            ...
            if(o) {
                ...
                e("<input>", {
                    type: "hidden", name:a.settings.preloadedInputName+"[]", value:i
                }
                ).appendTo(l)
            }
        ...
        ,
        f=function(e) {
            return !(e.size>a.settings.maxSize)||(alert(`The file "${e.name}" exceeds the maximum size of $ {
        ...
        ,
        m=function(e, t) {
            return !(e+s.items.length+a.settings.preloaded.length>=a.settings.maxFiles)||(alert(`The file "${t.name}" could not be added because the limit of $ {
                a.settings.maxFiles
            }
            files was reached`),  !1)
        }
