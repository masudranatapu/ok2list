         ...
         <ol class="breadcrumb">
            ...
            @if(isset($data['site_map_page2']) && ($data['site_map_page2']) != null )
                 ...
                 <div class="ads_banner text-center mb-4">
                     <a href="{{ $data['site_map_page2']->link }}" target="_blank" title="{{ $data['site_map_page2']->name }}"><img src="{{ fileExit($data['site_map_page2']->photo) }}" class="w-100" alt="{{ $data['site_map_page2']->name }}" style="height: 96px;"></a>
                 </div>
               ...
               <div class="row"></div>
                     <div class="section">
                        ...
                        <div class="sitemap_wrapper">
                           <h3><a target="_blank" href="{{route('ads.list', ['area' => 'srilanka', 'category' => $cat->url_slug])}}">{{ $cat->name }}</a></h3>
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <ul class="site_item_list">
                                    ...
                                    <li>
                                       <a target="_blank" href="{{route('ads.list', ['area' => 'srilanka', 'category' => $scat->url_slug])}}"><i class="fa fa-book"></i> {{ $scat->name }}</a>
                                    </li>
