            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="contact-info">
                        ...
                        <h2>{{ __('corporate_info') }}</h2>
                        <address>
                            @if ($link->website_email)
                            <p><strong>Email: </strong><a href="mailto:{{ $link->website_email }}">{{
                                    $link->website_email }}</a></p>
                            @endif
                            @if ($link->address)
                        ...
                        <ul class="social">
                            ...
                            <li><a target="_blank" href="{{ $link->facebook_link }}"><i class="fa fa-facebook"></i></a>
                            </li>
                            @endif
                            ...
                            <li><a href="{{ $link->youtube_link }}"><i style="color: #c1272d;"
                ...
                <div class="col-lg-8">
                    <div class="feedback">
                        <h2>{{ __('send_us_your_feedback') }}</h2>
                        {!! Form::open([
                        'route' => 'contact-us',
                        'method' => 'post',
                        'class' => 'form-contact',
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        {!! Form::number('capt', old('capt'), [
                                        'class' => 'form-control',
                                        'id' => 'usernumber',
                                        'placeholder' => 'Result',
                                        'data-validation-required-message' => 'This field is required',
                                        'oninput' => 'checkInputValCapt(this)',
                                        'tabindex' => 5,
                                        ]) !!}
                                        {!! $errors->first('capt', '<label
                                            class="help-block text-danger">:message</label>') !!}
                                    </div>
                                </div>
