        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2 class="title">@lang('web.did_not_find_your_answer_yet?')</h2>
                    <h4>@lang('web.send_us_a_note_to_help_center')</h4>
                    <a href="{{route('contact-us')}}" class="btn btn-primary">@lang('web.contact_us')</a>
                </div>
            </div>
        </div>
    </section>
