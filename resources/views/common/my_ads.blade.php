					...
					<div class="recommended-cta">
						<div class="cta">
							<div class="ad-profile section">
								...
								<ul class="user-menu">
									<li><a href="my-profile.html"><i class="fa fa-chevron-right"></i> My Profile</a></li>
									<li class="active"><a href="my-ads.html"><i class="fa fa-chevron-right"></i> My ads</a></li>
						...
						<div class="ad-item row">
							...
							<div class="item-info col-lg-8">
								...
								<div class="ad-info">
									...
									<a href="promotion.html" class="btn btn-danger" style="background: #ffc800;border: #ffc800; color: #673500;font-weight: bold;"><i class="fa fa-arrow-up"></i> Promote this ad</a>
									<div class="item-cat">
