				...
				<div class="row">
					<div class="col-lg-8">
						<div class="section postdetails terms_info">
							<h4>@lang('web.promote_your_ad')</h4>
					...
					<div class="col-lg-4">
						<div class="section quick-rules">
							...
							<ul>
								...
								<li>Do not post the same ad more than once or repost an ad within 48 hou₦.</li>
								<li>Do not upload pictures with watermarks.</li>
								<li>Do not post ads containing multiple items unless it's a package deal.</li>
								<li>Do not put your email or phone numbe₦ in the title or description.</li>
							</ul>
						</div>
					</div>
				</div>
