                                ...
                                <li class="contacts-list clist {{ $key == 0 ? 'clist-active' : '' }} "
                                    ...
                                    <div class="media p-1">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="mb-0 text-success" style="font-size: 12px; line-height: 16px;">₦
                            ...
                            <div class="d-flex bd-highlight">
                                ...
                                <ul id="to_parti">
                                    <li class="contacts-list clist  " data-pid="{{ $firstRow->prd_pk_no }}"
                                        ...
                                        <div class="media p-1">
                                            <img src="{{ $firstRow->img_path_thumb }}" alt="{{ $firstRow->from_name }}"
                                                class="mr-1" style="height:60px;">
                                            <div class="media-body">
                                                <h5
                                                    style="font-size: 16px; color: #000; margin-bottom: 2px; margin-top: 3px;">
                                                    {{ $parti ?? '' }}
                        ...
                        <div class="card-body msg_card_body" id="msg_card_body">
                            ...
                            <div class="d-flex justify-content-start mb-4">
                                <div class="msg_cotainer">
                                    {{ $txt->message }} {{-- (From-{{ $txt->created_by }}) (To-{{ $txt->to_pk_no
                                    }})Prod-{{ $txt->prd_pk_no }}) --}}
                                    <span class="msg_time_send">{{ date('d M, y, h:i A', strtotime($txt->created_at))
                                        }}</span>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="form-group" id="textfg">
                                <div class="input-group">
                                    <textarea name="message" class="form-control type_msg"
                                        placeholder="Type your message..." id="textSmg"></textarea>
