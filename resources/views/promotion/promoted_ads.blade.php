						...
						<div class="my-ads section">
							...
							<div class="ad-item row">
								...
								<div class="item-info col-lg-8">
									<div class="ad-info">
										<h3 class="item-price">₦ {{ number_format($row->price,2) }} <a href="javascript:void(0)"  class="pull-right c-btn">{{ $row->promotion }}</a></h3>
									...
									<div class="ad-meta">
										<div class="meta-content">
											...
											<span class="visito₦">Likes: {{ $row->total_like ?? '0' }}</span>
										    @endif--}}
