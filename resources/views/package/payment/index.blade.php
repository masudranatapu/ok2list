...
@section('content')
    ...
    @php
        $ss_packages = DB::table('ss_packages')
            ->where('pk_no', request()->get('promid'))
            ->first();
    @endphp
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card section mb-4">
                            <div class="card-body">
                                <h3 class="card-title">{{ __('urp') }}</h3>
                                <div class="card-table table-responsive">
                                    <table class="table table-vcenter">
                                        <thead>
                                            <tr>
                                                <th class="w-1">{{ __('des') }}</th>
                        ...
                        <div class="card section bank_info mb-4">
                            <div class="card-body">
                                <h3 class="card-title">{{ __('bank_info') }}</h3>
                                <div class="card-table">
                                    <p><strong> {{ __('bank_name') }} :</strong> Your bank Name</p>
                                    <p><strong>{{ __('acc') }} :</strong> Your Account Name</p>
                                    <p><strong> {{ __('acc_num') }} :</strong> Your account number</p>
                                    <p><strong> {{ __('acc_type') }} :</strong> Current Account</p>
                                    <p><strong>{{ __('branch') }} :</strong> Branch Name</p>
                                    <p><strong> {{ __('currency') }} :</strong> Nigeria Nira (₦)</p>
                                    <p><strong> {{ __('s_c') }} :</strong> Security Code</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card section">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-label">Billing City <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="billing_city" id="billing_city" class="form-control"
                                                placeholder="Billing City" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label">Billing State/Provice <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="billing_state" id="billing_state"
                                                class="form-control" placeholder="Billing State/Province" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label">Billing Zip Code <span
                                                    class="text-danger">*</span></label>
