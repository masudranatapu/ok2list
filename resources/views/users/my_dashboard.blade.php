                    ...
                    <div class="user-pro-section">
                            ...
                            <div class="form d-none edit-profile">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        {!! $errors->first('image', '<label class="help-block text-danger">:Profile
                                            Photo</label>') !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! $errors->first('seller_type', '<label
                                        class="help-block text-danger">:message</label>') !!}
                                </div>
                                <a style="margin-bottom: 9px;" href="{{ route('my-dashboard') }}"
                                    class="btn btn-info cancle">{{ __('cancle') }}</a>
                                <button style="padding: 7px 29px 5px;" type="submit" class="btn btn-primary">{{
                                    __('u_profile') }}</button>
                                {!! Form::close() !!}
                            </div>
                        </div>
                        ...
                        <div class="change-password section">
                            ...
                            <div class="form-group">
                                ...
                                {!! $errors->first('old_password', '<label
                                    class="help-block text-danger">:message</label>') !!}
                            </div>
                            <div class="form-group">
                        ...
                        <div class="user-pro-section section">
                            ...
                            <form
                                onclick="return confirm('{{ __(' Are you want to delete your account? if delete your account all data will be permanently deleted.') }}')"
                                action="{{ route('account.delete', auth()->id()) }}" method="POST">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn"
                                    style="margin-bottom: 9px;background:#ee1d23; color:#fff;">
