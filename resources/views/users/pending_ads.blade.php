                ...
                <div class="row">
                                ...
                                <div class="ad-profile">
                                    ...
                                    <ul class="user-menu">
                                        <li><a href="{{ route('my-profile') }}"><i class="fa fa-chevron-right"></i> My
                                                Profile</a></li>
                                        <li><a href="{{ route('my-ads') }}"><i class="fa fa-chevron-right"></i> My ads</a>
                                        </li>
                                        ...
                                        <li><a href="{{ route('ads-promotion') }}"><i class="fa fa-chevron-right"></i>
                                                Promotions</a></li>
                                        <li><a href="{{ route('my-membership') }}"><i class="fa fa-chevron-right"></i>
                                                Membership</a></li>
                                        <li class="active"><a href="{{ route('pending-ads') }}"><i
                                                    class="fa fa-chevron-right"></i> Pending approval</a></li>
                                    </ul>
                                </div><!-- ad-profile -->
                            </div>
                        </div><!-- cta -->
                    ...
                    <div class="col-xl-9">
                        <div class="my-ads section">
                            ...
                            <p class="text-danger">Your ad is under review. We will publish your add after reviewing soon.
                            ...
                            <div class="ad-item row">
                                ...
                                <div class="item-image-box col-lg-4">
                                    <div class="item-image">
                                        <a href="details.html"><img src="{{ asset('assets/images/listing/1.jpg') }}"
                                ...
                                <div class="item-info col-lg-8">
                                    ...
                                    <div class="ad-meta">
                                        <div class="meta-content">
                                            <span class="dated">Uploaded On: <a href="#">7 Jan, 16 10:10 pm
                                                </a></span>
                                            <span class="pending">Pending</span>
                                        </div>
                                        <!-- item-info-right -->
                                        <div class="user-option pull-right">
                                            <a class="edit-item" href="ad-post-details.html" data-toggle="tooltip"
                                                data-placement="top" title="Edit this ad"><i class="fa fa-pencil"></i></a>
                            ...
                            <div class="ad-item row">
                                <div class="item-image-box col-lg-4">
                                    <!-- item-image -->
                                    <div class="item-image">
                                        <a href="details.html"><img src="{{ asset('assets/images/listing/2.jpg') }}"
                                                alt="Image" class="img-fluid"></a>
                                    </div><!-- item-image -->
                                </div><!-- item-image-box -->
                                ...
                                <div class="item-info col-lg-8">
                                    ...
                                    <div class="ad-meta">
                                        ...
                                        <div class="user-option pull-right">
                                            <a class="edit-item" href="ad-post-details.html" data-toggle="tooltip"
                                                data-placement="top" title="Edit this ad"><i class="fa fa-pencil"></i></a>
                                            <a class="delete-item" href="#" data-toggle="tooltip"
                                                data-placement="top" title="Delete this ad"><i
                            ...
                            <div class="ad-item row">
                                <div class="item-image-box col-lg-4">
                                    <!-- item-image -->
                                    <div class="item-image">
                                        <a href="details.html"><img src="{{ asset('assets/images/listing/3.jpg') }}"
                                                alt="Image" class="img-fluid"></a>
                                    </div><!-- item-image -->
                                </div><!-- item-image-box -->
                                ...
                                <div class="item-info col-lg-8">
                                    ...
                                    <div class="ad-meta">
                                        ...
                                        <div class="user-option pull-right">
                                            <a class="edit-item" href="ad-post-details.html" data-toggle="tooltip"
                                                data-placement="top" title="Edit this ad"><i
                            ...
                            <div class="ad-item row">
                                <div class="item-image-box col-lg-4">
                                    <!-- item-image -->
                                    <div class="item-image">
                                        <a href="details.html"><img src="{{ asset('assets/images/listing/4.jpg') }}"
                                                alt="Image" class="img-fluid"></a>
                                    </div><!-- item-image -->
                                </div><!-- item-image-box -->
