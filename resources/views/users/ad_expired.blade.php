                        ...
                        <div class="user-pro-section">
                            ...
                            <div class="change-password section">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" value="{{ $ads->ad_title }}" readonly
                                        class="form-control">
                                ...
                                <div class="form-group">
                                    <label for="is_delete" class="{{ $ads->is_delete == '1' ? 'checked' : '' }}">
                                        <input type="checkbox" name="is_delete" id="is_delete" value="1"
                                            {{ $ads->is_delete == '1' ? 'checked' : '' }} style="height:12px"> Is Expired
                                    </label>
                                </div>
                                <a style="margin-bottom: 9px;" href="{{ route('my-ads') }}"
                                    class="btn btn-info cancle">Cancle</a>
