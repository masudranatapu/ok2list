        ...
        <div class="ad-profile">
            <div class="user-profile">
                ...
                <div class="favorites-user">
                    <div class="my-ads">
                        <a href="{{ route('my-ads') }}">{{ Auth::user()->total_post ?? 0 }}<small>{{ __('my_ads')
                                }}</small></a>
                    </div>
                    <div class="favorites">
                        <a href="{{ route('favorite-ads') }}">{{ Auth::user()->total_favorite ?? 0 }}<small>{{
                                __('favorites') }}</small></a>
                    </div>
                </div>
            </div><!-- user-profile -->
            @php
            ...
            <ul class="user-menu">
                ...
                <li class="{{ $curent_route == 'promoted-ads' ? 'active' : '' }}"><a href="{{ route('promotedads') }}">
                        {{ __('promote_ad') }}</a></li>
