                        ...
                        <div class="user-pro-section">
                            <div class="profile-details section createshopform">
                                ...
                                <div class="form">
                                                        ...
                                                        <div style="margin-bottom: 0px; text-align: center;"
                                                            ...
                                                            @if (!empty($shop_info->banner))
                                                                <img src="{{ $banner_path }}" alt="Logo"
                                                                    class="img-fluid" height="100px" width="120px" />
                                                            @endif
                                                            <span>
                                                                ...
                                                                <a href="#"
                                                                    ...
                                                                    data-dismiss="fileupload" id="remove-company_logo">
                                    ...
                                    <button style="padding: 4px 29px 4px;" type="submit" class="btn btn-primary">Update
                                        Shop</button>
                                    {!! Form::close() !!}
                                </div>
                            </div>
