...
$bed_combo = Config::get('static_arrays.number_fo_bed') ?? [];
$bath_combo = Config::get('static_arrays.number_fo_bath') ?? [];
$feature_property = Config::get('static_arrays.feature_property') ?? [];
$property_unit_combo = Config::get('static_arrays.property_unit') ?? [];
        ...
        <div class="container">
            ...
            <div class="adpost-details">
                <div class="row">
                    <div class="col-lg-8">
                        {!! Form::open([
                            'route' => ['update-post-property.update', $row->pk_no],
                            'method' => 'post',
                            ...
                            <div class="section postdetails">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9 user-type">
                                        <input type="radio" {{ $row->ad_type == 'sell' ? 'checked' : '' }}
                                            name="sell_type" value="rent" id="rent" checked> <label
                                            for="rent">For Rent</label>
                                        <input type="radio" {{ $row->ad_type == 'buy' ? 'checked' : '' }} name="sell_type"
                                            value="sell" id="sell" checked> <label for="sell">For Sell</label>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group brand-name {!! $errors->has('location') ? 'error' : '' !!}">
                                    <label class="col-sm-3 label-title">Division & City<span
                                            class="required">*</span></label>
                                    <div class="col-sm-9">
                                        <div class="controls">
                                ...
                                <div class="row form-group select-condition">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="radio" name="using_condition" value="new" id="new"
                                            {{ $row->using_condition == 'new' ? 'checked' : '' }}><label
                                            for="new">New</label>
                                        <input type="radio" name="using_condition" value="used" id="used"
                                            {{ $row->using_condition == 'used' ? 'checked' : '' }}><label
                                            for="used">Used</label>
                                        @if ($subcat_id == 13 || $subcat_id == 14 || $subcat_id == 17)
                                            <input type="radio" name="using_condition" value="reconditioned"
                                                id="reconditioned"
                                                {{ $row->using_condition == 'reconditioned' ? 'checked' : '' }}><label
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9 user-type">
                                        ...
                                        <input type="radio" name="authenticity" value="refurbished" id="refurbished"
                                ...
                                <div class="row form-group select-price {!! $errors->has('price') ? 'error' : '' !!}">
                                    <label class="col-sm-3 label-title"><span id="price_label">Rent (₦) /month</span><span
                                            class="required">*</span></label>
                                    <div class="col-sm-9">
                                        <div class="controls">
                                ...
                                @if ($subcat_id == 33)
                                    <div class="row form-group brand-name {!! $errors->has('bed') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::select('bed', $bed_combo, $row->bed_no, [
                                                    'class' => 'form-control js-example-basic-single',
                                                    'id' => 'bed',
                                                    'data-validation-required-message' => 'This field is required',
                                ...
                                @if ($subcat_id == 33)
                                    <div class="row form-group brand-name {!! $errors->has('bath') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::select('bath', $bath_combo, $row->bath_no, [
                                                    'class' => 'form-control js-example-basic-single',
                                                    'id' => 'bath',
                                                    'data-validation-required-message' => 'This field is required',
                                ...
                                @if ($subcat_id == 33 || $subcat_id == 107)
                                    <div class="row form-group  {!! $errors->has('size') ? 'error' : '' !!}">
                                        <label class="col-sm-3 label-size">Size (sqft)<span
                                                class="required">*</span></label>
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::number('size', old('size'), [
                                                    'class' => 'form-control',
                                                    'data-validation-required-message' => 'This field is required',
                                                    'placeholder' => 'Size',
                                                    'minlength' => '0',
                                                    'data-validation-minlength-message' => 'Minimum 0 digit',
                                                    'maxlength' => '9999999999',
                                                    'data-validation-maxlength-message' => 'Maximum 10 digit',
                                                    'autocomplete' => 'off',
                                                    'tabindex' => 1,
                                                    'step' => '0.01',
                                                ]) !!}
                                    ...
                                    <div class="row form-group  {!! $errors->has('size') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="controls">
                                                        {!! Form::number('size', $row->house_size, [
                                                            'class' => 'form-control',
                                                            'data-validation-required-message' => 'This field is required',
                                                            'placeholder' => 'Size',
                                                            'minlength' => '0',
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="controls">
                                                        {!! Form::select('property_unit', $property_unit_combo, $row->house_unit, [
                                                            'class' => 'form-control js-example-basic-single',
                                                            'id' => 'property_unit',
                                                            'data-validation-required-message' => 'This field is required',
                                                            'placeholder' => 'Unit',
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9 pl-4">
                                        <label for="is_active">
                                            <input type="checkbox" name="is_active" id="is_active" value="2"
                                                {{ $row->is_active == '2' ? 'checked' : '' }}> Is Expired
                                        </label>
                                    </div>
                                </div>
