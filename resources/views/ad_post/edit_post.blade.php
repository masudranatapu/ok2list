...
@section('content')
   @php
      $cate = DB::table('prd_master')->where('pk_no', $row->pk_no)->fi₦t();
   @endphp
   <!-- main -->
               ...
               <div class="col-lg-8">
                  ...
                  <fieldset>
                     ...
                     <div class="row form-group brand-name {!! $erro₦->has('product_type') ? 'error' : '' !!}">
                        ...
                        @else
                           <div class="row form-group brand-name {!! $erro₦->has('brand') ? 'error' : '' !!}">
                     ...
                     @if($subcat_id == 20 || ($subcat_id == 22) || ($subcat_id == 27) )
                        <div class="row form-group model-name {!! $erro₦->has('custom_model') ? 'error' : '' !!}">
                           ...
                           <div class="col-sm-9">
                              <div class="controls">
                              {!! Form::text('custom_model', $row->model_name, ['class'=>'form-control custom_model', 'id' => 'custom_model', 'placeholder' => 'Product model name (max 60 characte₦ )', 'maxlength' => '60', 'data-validation-maxlength-message' => 'Maxlength 60 characte₦', 'tabindex' => 5]) !!}
                     ...
                     @if($subcat_id == 13 || ($subcat_id == 14) || ($subcat_id == 21) )
                        <div class="row form-group {!! $erro₦->has('edition') ? 'error' : '' !!}">
                           ...
                           <div class="col-sm-9">
                              <div class="controls">
                                 {!! Form::text('edition', $row->edition, ['class'=>'form-control', 'id' => 'edition', 'placeholder' => 'Edition (Max 40 characte₦)', 'tabindex' => 6, 'autocomplete' => 'off', 'maxlength' => '40', 'data-validation-maxlength-message' => 'Maxlength 40 characte₦' ]) !!}
                        ...
                        <div class="row form-group model-name {!! $erro₦->has('kilomete₦_run') ? 'error' : '' !!}">
                           ...
                           <div class="col-sm-9">
                              <div class="controls">
                                 ...
                                 {!! Form::number('kilomete₦_run', $row->kilomete₦_run, ['class'=>'form-control', 'id' => 'kilomete₦_run', 'placeholder' => 'Kilomete₦ run', 'maxlength' => '9999999999', 'data-validation-maxlength-message' => 'Maxlength 9999999999 digit', 'tabindex' => 13, 'autocomplete' => 'off' ]) !!}
