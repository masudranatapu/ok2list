...
$prod_feature_arr = $row->prod_feature_arr ?? [];
$fuel_type_arr = $row->fuel_type_arr ?? [];
...
@section('content')
    @php
        $cate = DB::table('prd_master')
            ->where('pk_no', $row->pk_no)
            ->first();
    @endphp
    <!-- main -->
        ...
        <div class="container">
            ...
            <div class="adpost-details">
                <div class="row">
                    <div class="col-lg-8">
                        {!! Form::open([
                            'route' => ['update-post-general.update', $row->pk_no],
                            'method' => 'post',
                            ...
                            <div class="section postdetails">
                                ...
                                <div class="form-group selected-product">
                                    <ul class="select-category list-inline">
                                        <li>
                                            <a
                                                href="{{ route('edit-post', ['id' => $row->pk_no, 'type' => 'general', 'category' => $row->f_scat_pk_no]) }}">
                                                <span class="select">
                                                    <img src="{{ asset('assets/images/icon/2.png') }}" alt="Images"
                                                        class="img-fluid">
                                                </span>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9 user-type">
                                        <input type="radio" name="sell_type" value="sell" id="sell"
                                            {{ $row->ad_type == 'sell' ? 'checked' : '' }}> <label for="sell">I want to
                                            sell </label>
                                        <input type="radio" name="sell_type" value="buy" id="buy"
                                            {{ $row->ad_type == 'buy' ? 'checked' : '' }}> <label for="buy">I want to
                                            buy</label>
                                    </div>
                                </div>
                                @if (count($product_type_combo) > 0)
                                    <div class="row form-group brand-name {!! $errors->has('product_type') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::select('product_type', $product_type_combo, $row->prod_type, [
                                    ...
                                    <div class="col-sm-9">
                                        <div class="controls">
                                            <select class="form-control js-example-basic-single select2-hidden-accessible"
                                                name="location" id="location" data-url="{{ URL::to('get-area') }}">
                                                @if ($city_combo)
                                                    <optgroup label="City">
                                                        @foreach ($city_combo as $kc => $city)
                                                            <option value="{{ $city->pk_no }}" data-type="city"
                                                                @if ($row->city_division == 'city') {{ $row->area->city->pk_no == $city->pk_no ? 'selected' : '' }} @endif>
                                                                {{ $city->name }} City</option>
                                                        @endforeach
                                                    </optgroup>
                                                @endif
                                                ...
                                                @if ($division_combo)
                                                    <optgroup label="Division">
                                                        @foreach ($division_combo as $kd => $divi)
                                                            <option value="{{ $divi->pk_no }}" data-type="division"
                                                                @if ($row->city_division == 'division') {{ $row->area->division->pk_no == $divi->pk_no ? 'selected' : '' }} @endif>
                                                                {{ $divi->name }}</option>
                                                        @endforeach
                                                    </optgroup>
                                                @endif
                                ...
                                <div class="row form-group brand-name {!! $errors->has('area') ? 'error' : '' !!}">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="controls">
                                            {!! Form::select('area', $area_combo, $row->area_id, [
                                                'class' => 'form-control js-example-basic-single',
                                                'id' => 'area',
                                                'data-validation-required-message' => 'This field is required',
                                ...
                                @else
                                    <div class="row form-group select-condition">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="radio" name="using_condition" value="new" id="new"
                                                {{ $row->using_condition == 'new' ? 'checked' : '' }}>
                                            <label for="new">New</label>
                                            <input type="radio" {{ $row->using_condition == 'used' ? 'checked' : '' }}
                                                name="using_condition" value="used" id="used">
                                            <label for="used"
                                                {{ $row->using_condition == 'used' ? 'checked' : '' }}>Used</label>
                                            @if ($subcat_id == 13 || $subcat_id == 14 || $subcat_id == 17)
                                                <input type="radio"
                                                    {{ $row->using_condition == 'reconditioned' ? 'checked' : '' }}
                                                    name="using_condition" value="reconditioned" id="reconditioned"
                                                    {{ $row->using_condition == 'reconditioned' ? 'checked' : '' }}>
                                ...
                                @else
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9 user-type">
                                            <input type="radio" name="authenticity" value="original" id="original"
                                                {{ $row->authenticity == 'original' ? 'checked' : '' }}> <label
                                                for="original">Original </label>
                                            <input type="radio" name="authenticity" value="refurbished"
                                                id="refurbished"
                                                {{ $row->authenticity == 'refurbished' ? 'checked' : '' }}> <label
                                ...
                                @else
                                    <div class="row form-group brand-name {!! $errors->has('brand') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::select('brand', $brand_combo, $row->f_brand, [
                                ...
                                @if ($subcat_id == 13 || $subcat_id == 14 || $subcat_id == 21)
                                    <div class="row form-group model-name {!! $errors->has('prod_model') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::select('prod_model', [], $row->f_model, [
                                ...
                                @if ($subcat_id == 20 || $subcat_id == 22 || $subcat_id == 27)
                                    <div class="row form-group model-name {!! $errors->has('custom_model') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::text('custom_model', $row->model_name, [
                                ...
                                @if ($subcat_id == 13 || $subcat_id == 14 || $subcat_id == 17)
                                    <div class="row form-group {!! $errors->has('model_year') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::number('model_year', $row->model_year, [
                                                    'class' => 'form-control',
                                                    'id' => 'model_year',
                                                    'maxlength' => '4',
                                ...
                                @if ($subcat_id == 13)
                                    <div class="row form-group {!! $errors->has('registration_year') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::number('registration_year', $row->registration_year, [
                                                    'class' => 'form-control',
                                    ...
                                    <div class="row form-group select-condition">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="radio" name="transmission" value="Manual" id="Manual"
                                                {{ $row->transmission == 'Manual' ? 'checked' : '' }}><label
                                                for="Manual">Manual</label>
                                            <input type="radio" name="transmission" value="Other_transmission"
                                                id="Other_transmission"
                                                {{ $row->transmission == 'Other_transmission' ? 'checked' : '' }}><label
                                                for="Other_transmission">Other transmission</label>
                                            <input type="radio" name="transmission" value="Automatic" id="Automatic"
                                                {{ $row->transmission == 'Automatic' ? 'checked' : '' }}><label
                                ...
                                @if ($subcat_id == 13)
                                    <div class="row form-group  {!! $errors->has('body_type') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                {!! Form::select('body_type', $car_body_type, $row->body_type, [
                                                    'class' => 'form-control js-example-basic-single',
                                                    'id' => 'body_type',
                                                ...
                                                @if ($fuel_type)
                                                    @foreach ($fuel_type as $ft => $value)
                                                        ...
                                                        <label for="{{ $ft }}" class="{{ $res }}">
                                                            <input type="checkbox" {{ $res }} name="fuel_type[]"
                                                                id="{{ $ft }}" value="{{ $ft }}">
                                                            {{ $value }}</label>
                                                    @endforeach
                                                @endif
                                    ...
                                    <div class="row form-group {!! $errors->has('engine_capacity') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                ...
                                                {!! Form::number('engine_capacity', $row->engine_capacity, [
                                                    'class' => 'form-control',
                                                    'id' => 'engine_capacity',
                                                    'placeholder' => 'Engine capacity (maximum 99)',
                                                    'maxlength' => '99',
                                    ...
                                    <div class="row form-group model-name {!! $errors->has('kilometers_run') ? 'error' : '' !!}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="controls">
                                                ...
                                                {!! Form::number('kilometers_run', $row->kilometers_run, [
                                                    'class' => 'form-control',
                                                    'id' => 'kilometers_run',
                                            ...
                                            <div class="checkbox">
                                                @if ($additional_feature_mobile)
                                                    @foreach ($additional_feature_mobile as $ft => $value)
                                                        ...
                                                        ?>
                                                        <label for="{{ $ft }}"
                                                            class="{{ $res }}"><input type="checkbox"
                                                                name="prod_feature[]" id="{{ $ft }}"
                                                                value="{{ $ft }}"> {{ $value }}</label>
                                                    @endforeach
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="controls">
                                            {!! Form::textarea('description', $row->description, [
                                                'class' => 'form-control',
                                                'data-validation-required-message' => 'This field is required',
                                                'placeholder' => 'WriWrite a few  lines about your products. Also mention your product brand.',
                                                'minlength' => '50',
                                                'maxlength' => '4000',
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="controls">
                                            <div class="pl-2">
                                                <label for="is_delete"
                                                    class="{{ $row->is_delete == '1' ? 'checked' : '' }}">
                                                    <input type="checkbox" name="is_delete" id="is_delete"
                                                        value="1" {{ $row->is_delete == '1' ? 'checked' : '' }}> Is
                                                    Expired
                                                </label>
                                            </div>
                                        </div>
                               ...
                               Send me Trade Email/SMS Alerts for people looking to buy mobile handsets in www By clicking "Post", you agree to our <a target="_blank" href="{{ route('terms-conditions') }}">Terms of Use</a> and <a target="_blank" href="{{ route('privacy-policy') }}">Privacy Policy</a> and acknowledge that you are the rightful owner of this item and using Trade to find a genuine buyer.
                                    ...
                                    <button type="submit" class="btn btn-success mt-3 " name="submit"
                                        value="save">Update Your Ad </button>
                                    <button type="submit" class="btn btn-warning mt-3 " name="submit"
                                        value="draft">Update as draft </button>
