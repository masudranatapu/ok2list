...
$receive_app_via_combo = Config::get('static_arrays.receive_applications_via_combo') ?? [];
$edu_specialization_combo = Config::get('static_arrays.edu_specialization') ?? [];
$business_function_combo = Config::get('static_arrays.business_function') ?? [];
$mini_qualification_combo = Config::get('static_arrays.edu_qulafication') ?? [];
$gender_combo = Config::get('static_arrays.gender') ?? [];
                                        ...
                                        <div class="section postdetails">
                                            ...
                                            @if (!empty($product_type_combo) && count($product_type_combo) > 0)
                                                <div class="row form-group brand-name {!! $errors->has('product_type') ? 'error' : '' !!}">
                                                    <label class="col-sm-3 label-title">Job Type<span
                                            ...
                                            <div class="row form-group add-title {!! $errors->has('title') ? 'error' : '' !!}">
                                                <label class="col-sm-3 label-title">Title<span
                                                        class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                            ...
                                            <div class="row form-group {!! $errors->has('business_function') ? 'error' : '' !!}">
                                                <label class="col-sm-3 ">Business Function <span
                                                        class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                                        {!! Form::select('business_function', $business_function_combo, old('business_function') ?? '', [
                                                            'class' => 'form-control js-example-basic-single',
                                            ...
                                            <div class="row form-group {!! $errors->has('role') ? 'error' : '' !!}">
                                                <label class="col-sm-3 ">Role / Designation<span
                                                        class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                                        {!! Form::text('role', old('role'), [
                                                            ...
                                                            'minlength' => '2',
                                                            'data-validation-required-message' => 'This field is required',
                                                            'data-validation-minlength-message' => 'Minimum 2 characters',
                                                            'maxlength' => '60',
                                                            'data-validation-maxlength-message' => 'Maximum 60 characters',
                                                            'autocomplete' => 'off',
                                                            'tabindex' => 1,
                                            ...
                                            <div class="row form-group {!! $errors->has('receive_applications_via') ? 'error' : '' !!}">
                                                <label class="col-sm-3 ">Receive Response<span class="required">*</span>
                                                </label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                                        {!! Form::select(
                                                            'receive_applications_via',
                                                            $receive_app_via_combo,
                                                            old('receive_applications_via') ?? 'dashboard',
                                                            [
                                                                'class' => 'form-control js-example-basic-single',
                                                                'id' => 'receive_applications_via',
                                                                'data-validation-required-message' => 'This field is required',
                                                                'placeholder' => 'Select one',
                                                                'tabindex' => 4,
                                                            ],
                                            ...
                                            <div class="row form-group select-price {!! $errors->has('price') ? 'error' : '' !!}">
                                                <label class="col-sm-3 label-title">Salary (per month) (₦)<span
                                                        class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="controls">
                                                                {!! Form::number('price_to', old('price_to'), [
                                                                    'class' => 'form-control',
                                                                    'data-validation-required-message' => 'This field is required',
                                                                    'placeholder' => 'To',
                                                                    'minlength' => '0',
                                            ...
                                            <div class="row form-group {!! $errors->has('total_vacancies') ? 'error' : '' !!}">
                                                <label class="col-sm-3 ">Total vacancies<span
                                                        class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                                        {!! Form::number('total_vacancies', old('total_vacancies'), [
                                                            'class' => 'form-control',
                                                            'data-validation-required-message' => 'This field is required',
                                            ...
                                            <div class="row form-group {!! $errors->has('deadline') ? 'error' : '' !!}">
                                                <label class="col-sm-3 ">Application Deadline<span
                                                        class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                                        {!! Form::text('deadline', old('deadline'), [
                                                            'class' => 'form-control datepicker',
                                                            'placeholder' => 'Appliaction deadline',
                                                            'data-validation-required-message' => 'This field is required',
                                                            'autocomplete' => 'off',
                                                            'tabindex' => 1,
                                                        ]) !!}
