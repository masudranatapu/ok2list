                                        ...
                                        <div class="section postdetails">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9 user-type">
                                                    <input type="radio" name="sell_type" value="rent" id="rent"
                                                        checked> <label for="rent">For Rent</label>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9 user-type">
                                                    <input type="radio" name="authenticity" value="original"
                                                        id="original"> <label for="original">Original </label>
                                            ...
                                            <div class="row form-group select-price {!! $errors->has('price') ? 'error' : '' !!}">
                                                <label class="col-sm-3 label-title"><span id="price_label">Rent (₦)
                                                        /month</span><span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                            ...
                                            @if ($subcat_id == 33)
                                                <div class="row form-group brand-name {!! $errors->has('bed') ? 'error' : '' !!}">
                                                    <label class="col-sm-3 label-title">Bed<span
                                                            class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            {!! Form::select('bed', $bed_combo, old('bed'), [
                                                                'class' => 'form-control js-example-basic-single',
                                                                'id' => 'bed',
                                                                'data-validation-required-message' => 'This field is required',
                                            ...
                                            @if ($subcat_id == 33)
                                                <div class="row form-group brand-name {!! $errors->has('bath') ? 'error' : '' !!}">
                                                    <label class="col-sm-3 label-title">Bath<span
                                                            class="required">*</span></label>
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            {!! Form::select('bath', $bath_combo, old('bath'), [
                                                                'class' => 'form-control js-example-basic-single',
                                                                'id' => 'bath',
                                                                'data-validation-required-message' => 'This field is required',
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            @if ($feature_property)
                                                                @foreach ($feature_property as $ft => $value)
                                                                    <input type="radio" name="prod_feature[]"
                                                                        value="{{ $ft }}"
                                                                        id="{{ $ft }}"> <label
                                                                        for="{{ $ft }}">{{ $value }}
                                                                    </label>
                                                ...
                                                <div class="row form-group  {!! $errors->has('size') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="controls">
                                                                    {!! Form::select('property_unit', $property_unit_combo, old('property_unit') ?? 'katha', [
                                                                        'class' => 'form-control select2',
                                                                        'id' => 'property_unit',
                                                                        'data-validation-required-message' => 'This field is required',
                                                                        'placeholder' => 'Unit',
