					...
					<div class="my-ads section">
						...
						Update Shop
							@if( !empty( $data['shop_data'] ) )
							 <a href="{{route('shop_page_details',['id' => $data['shop_data']->pk_no, 'url_slug' => $data['shop_data']->url_slug ])}}" class="btn-sm btn-primary float-right">Let's go to your Shop</a>
							@endif
						</h3>
						<hr>
						<div class="row mt-4">
							<div class="item-info col-12">
								...
								<div class="form">
									...
									<button style="padding: 4px 29px 9px;" type="submit" class="btn btn-primary">Update Shop</button>
									{!! Form::close() !!}
								</div>
								@else
