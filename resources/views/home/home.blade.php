...
@section('content')
    ...
    {{-- @if (isset($data['home_page1']) && $data['home_page1'] != null)
        <div class="container">
            <div class="ads_banner text-center mb-5">
                <a href="{{ $data['home_page1']->link }}" target="_blank" title="{{ $data['home_page1']->name }}"><img
                        src="{{ fileExit($data['home_page1']->photo) }}" class="w-100" alt="{{ $data['home_page1']->name }}"
                        style="height: 96px;"></a>
            </div>
        </div>
    @endif --}}
    ...
    <section id="home-two-info" class="clearfix home-two mt-5">
    ...
    {{-- @if (isset($data['home_page2']) && $data['home_page2'] != null)
        <div class="container">
            <div class="ads_banner text-center mb-4">
                <a href="{{ $data['home_page2']->link }}" target="_blank" title="{{ $data['home_page2']->name }}"><img
                        src="{{ fileExit($data['home_page2']->photo) }}" class="w-100" alt="{{ $data['home_page2']->name }}"
                        style="height: 96px;"></a>
            </div>
        </div>
    @endif --}}
    ...
    {{-- @if (isset($data['home_page3']) && $data['home_page3'] != null)
        <div class="container">
            <div class="ads_banner text-center mb-4">
                <a href="{{ $data['home_page3']->link }}" target="_blank" title="{{ $data['home_page3']->name }}"><img
                        src="{{ fileExit($data['home_page3']->photo) }}" class="w-100" alt="{{ $data['home_page3']->name }}"
                        style="height: 96px;"></a>
            </div>
        </div>
    @endif --}}
