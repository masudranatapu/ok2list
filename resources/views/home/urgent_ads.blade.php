            ...
            <div id="featured-slider-two">
                ...
                <div class="featured">
                    <div class="featured-image">
                        <a href="{{route('ad.details',['pk_no' => $ad->pk_no, 'url_slug' => $ad->url_slug])}}"><img
                                src="{{ asset('assets/images/default-load.png')}}"
                                data-src="{{ asset($ad->img_path_thumb)}}" alt="{{$ad->ad_title}}"
                                class="img-fluid"></a>
                    ...
                    <div class="ad-info">
                        ...
                        <h4 class="item-title"><a
                                href="{{route('ad.details',['pk_no' => $ad->pk_no, 'url_slug' => $ad->url_slug])}}">{{
                                $ad->ad_title }}</a></h4>
                        <div class="item-cat">
                            <span><a
                                    href="{{route('ad.details',['pk_no' => $ad->pk_no, 'url_slug' => $ad->url_slug])}}">{{
                                    $ad->subcategory->name ?? '' }}</a></span>
                        </div>
                    ...
                    <div class="ad-meta">
                        <div class="meta-content">
                            <span class="dated"><a
                                    href="{{route('ad.details',['pk_no' => $ad->pk_no, 'url_slug' => $ad->url_slug])}}">{{date('d
                                    M Y h:i A',strtotime($ad->created_at))}} </a></span>
                        </div>

                        <div class="user-option pull-right">
                            <a href="javascript:void(0)" data-toggle="tooltip" data-placement="top"
                                title="{{$ad->area->name }}, {{ $ad->city_division == 'city' ? $ad->area->city->name : '' }} {{ $ad->city_division == 'division' ? $ad->area->division->name : '' }}"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="bottom">
                                <p>
                                    <a
                                        href="{{ route('ad.details', ['pk_no' => $ad->pk_no, 'url_slug' => $ad->url_slug]) }}">{{
                                        date('d M Y h:i A', strtotime($ad->created_at)) }}
                                    </a>
