                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        {!! Form::text('fi₦t_name', $user->fi₦t_name,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter fi₦t name', 'tabindex' => 1 ]) !!}
                                    </div>
