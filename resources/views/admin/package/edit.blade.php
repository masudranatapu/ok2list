                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$row->title}}" name="title" placeholder="Package Name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="sms_feature" id="sms_feature" class="form-control" required>
                                                <option value="1" @php if ($row['sms_feature'] == 1) { echo "selected"; } @endphp>Yes</option>
                                                <option value="0" @php if ($row['sms_feature'] == 0) { echo "selected"; } @endphp>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="email_feature" class="form-control" id="" required>
                                                <option value="1" @php if ($row['email_feature'] == 1) { echo "selected"; } @endphp>Yes</option>
                                                <option value="0" @php if ($row['email_feature'] == 0) { echo "selected"; } @endphp>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="shop_page" class="form-control" id="shop_page" required>
                                                <option value="1" @php if ($row['shop_page'] == 1) { echo "selected"; } @endphp>Yes</option>
                                                <option value="0" @php if ($row['shop_page'] == 0) { echo "selected"; } @endphp>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="analytics" class="form-control" id="analytics" required>
                                                <option value="1" @php if ($row['analytics'] == 1) { echo "selected"; } @endphp>Yes</option>
                                                <option value="0" @php if ($row['analytics'] == 0) { echo "selected"; } @endphp>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{$row->ad_limit_in_montrh}}" name="ad_limit_in_montrh" placeholder="Add Limit Per Month">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="package" >Package Duration</label>
                                            <input type="number" class="form-control" value="{{$row->package_duration}}" name="package_duration" placeholder="Package Duration">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="package" >Support Duration</label>
                                            <input type="text" class="form-control" value="{{$row->support_duration}}" name="support_duration" placeholder="Support Duration">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="package" >Discount On Promotion</label>
                                            <input type="number" class="form-control" value="{{$row->discount_on_promotion}}" name="discount_on_promotion" placeholder="Discount On Promotion">
                                        </div>
                                    </div>
                                </div>
