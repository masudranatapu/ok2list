...
@section('title') {{ __('create_area') }} @endsection
@section('page-name') {{ __('create_area') }} @endsection

@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}">{{ __('admin_breadcrumb_title') }}</a>
    </li>
    <li class="breadcrumb-item active">{{ __('create_area') }}</li>
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {!! $errors->has('city_id') ? 'error' : '' !!}">
                                        <label>{{ __('city') }}</label>
                                        <div class="controls">
                                            {!! Form::select('city_id', $city_combo, null, [
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {!! $errors->has('   division_id') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::select('  division_id', $division_combo, null, [
                                                'class' => 'form-control mb-1 select2',
                                                'id' => '  division_id',
