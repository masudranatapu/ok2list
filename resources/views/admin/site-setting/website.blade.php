                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input type="email" name="website_email" value="{{$setting->website_email}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-2">
                                    <label class="form-label">Phone Number</label>
                                    <input type="number" name="phone" value="{{$setting->phone}}" class="form-control" placeholder="Phone number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-2">
                         ...
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="mb-2">
                                     ...
                                     <input type="text" name="facebook_link" class="form-control" value="{{$setting->facebook_link}}"  placeholder="https:://www.facebook.com">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="mb-2">
                                     <label class="form-label">Twitter</label>
                                     <input type="text" name="twitter_link" class="form-control" value="{{$setting->twitter_link}}" placeholder="https:://www.twitter.com">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="mb-2">
                                     <label class="form-label">Instagram</label>
                                     <input type="text" name="instagram_link" class="form-control" value="{{$setting->instagram_link}}" placeholder="https:://www.instagram.com">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="mb-2">
                                     <label class="form-label">Linkedin</label>
                                     <input type="text" name="linkedin_link" class="form-control" value="{{$setting->linkedin_link}}" placeholder="https:://www.linkedin.com">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="mb-2">
                                     <label class="form-label">Whatsapp</label>
                                     <input type="text" name="whatsapp_link" class="form-control" value="{{$setting->whatsapp_link}}" placeholder="https:://www.whatsapp.com">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="mb-2">
                                     <label class="form-label">Youtube</label>
                                     <input type="text" name="youtube_link" class="form-control" value="{{$setting->youtube_link}}" placeholder="https:://www.youtube.com">
                                 </div>
                             </div>
                             <div class="col-12 text-center mt-2">
                                <button type="submit" class="btn btn-primary">Update Settings</button>
