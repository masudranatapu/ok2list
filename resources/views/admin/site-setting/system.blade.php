				...
				<div class="row mb-2">
					...
					<div class="col-md-6">
						<div class="mb-2">
							...
							<input type="text" name="app_url" class="form-control" placeholder="App URL">
						</div>
					</div>
					<div class="col-md-6">
						<div class="mb-2">
							<label class="form-label">Timezone</label>
							<select name="timezone" class="form-control selectbox">
					...
					<div class="col-md-6">
						<div class="mb-2">
							<label class="form-label">App Debug <span class="text-danger">*</span></label> <br/>
				...
				<div class="card-body">
					<div class="row mb-2">
						...
						<div class="col-sm-6 col-md-4">
							<div class="mb-2">
								<label class="form-label">Connection <span class="text-danger">*</span></label>
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-12">
							<div>
								<h4>Default Language & Currency</h4>
							</div><hr>
						</div>
						<div class="col-sm-6">
							<div class="mb-2">
								<label class="form-label">Set Default Language <span class="text-danger">*</span></label>
						...
						<div class="col-sm-6">
							<div class="mb-2">
								<label class="form-label">Set Default Currency <span class="text-danger">*</span></label>
