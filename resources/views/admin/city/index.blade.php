                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('admin.city.edit',$row->pk_no) }}" title="EDIT" class="btn btn-xs btn-outline-primary mr-1"><i class="la la-edit"></i></a>
                        @endif

                        @if(hasAccessAbility('delete_city', $roles))
                        <a href="{{route('admin.city.delete', [$row->pk_no])}}" class="btn btn-xs btn-outline-danger mr-1" title="DELETE" onclick="return confirm('Are you sure you want to delete?')"><i class="la la-trash"></i>
                        </a>
                        @endif
