...
@section('title') {{ __('product_model_edit') }} @endsection

@section('page-name') {{ __('product_model_edit') }} @endsection

@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}">{{ __('admin_breadcrumb_title') }}</a>
    </li>
    <li class="breadcrumb-item active">{{ __('product_model_edit') }}</li>
@endsection
...
@section('content')
    ...
    <div class="card" style="height: 588.5px;">
        ...
        <div class="card-content collapse show">
            <div class="card-body">
                {!! Form::open([
                    'route' => ['admin.product-model.update', $row->pk_no],
                    'method' => 'post',
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group {!! $errors->has('category') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::select('category', $category_combo, $row->cat_pk_no, [
                        ...
                        <div class="col-md-6">
                            <div class="form-group {!! $errors->has('sub_category') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::select('sub_category', $subcategory_combo, $row->scat_pk_no, [
                                        'class' => 'form-control mb-1 select2',
                                        'id' => 'sub_category',
                        ...
                        <div class="col-md-6">
                            <div class="form-group {!! $errors->has('brand') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::select('brand', $brand_combo, $row->brand_pk_no, [
                                        'class' => 'form-control mb-1 select2',
                                        'id' => 'brand',
                                        'data-validation-required-message' => 'This field is required',
