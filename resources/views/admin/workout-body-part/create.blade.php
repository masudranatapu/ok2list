...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.workout-body-parts') }}"> Body Parts </a>
    </li>
    <li class="breadcrumb-item active">Create Body Parts
    </li>
@endsection
@section('content')
    <div class="card" style="height: 588.5px;">
        ...
        <div class="card-content collapse show">
            <div class="card-body">
                {!! Form::open([ 'route' => 'admin.workout-body-parts.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                @csrf
                <div class="form-body">
