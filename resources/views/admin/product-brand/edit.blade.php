...
@section('title') {{ __('update_bra') }} @endsection

@section('page-name') {{ __('update_bra') }} @endsection

@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}">{{ __('admin_breadcrumb_title') }}</a>
    </li>
    <li class="breadcrumb-item active">{{ __('update_bra') }}</li>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open([
                                'route' => ['admin.brand.update', $row->pk_no],
                                'method' => 'post',
