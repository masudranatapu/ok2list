...
@section('title') {{ __('Payment_Update') }} @endsection
@section('page-name') {{ __('Payment_Update') }} @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#">{{ __('breadcrumb_title') }}</a></li>
    <li class="breadcrumb-item active">{{ __('Payment_Update') }} </li>
@endsection
                                        ...
                                        @if (!empty($transaction->package->title))
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $transaction->package->title ?? '' }}"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    placeholder="Payment Type" readonly>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"
                                                    value="{{ $transaction->amount ?? '' }}" placeholder="Package Price"
                                                    readonly>
                                                <input type="hidden" class="form-control"
                                                    value="{{ $transaction->pk_no ?? '' }}" name="transaction_id">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control" id="shop_page" required>
                                                    ...
                                                    <option value="VALID">{{ __('paid') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
