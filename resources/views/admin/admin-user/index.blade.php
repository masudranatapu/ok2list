...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('admin_user') }}
    </li>
@endsection
                            ...
                            @if (hasAccessAbility('add_admin_user', $roles))
                                <a class="text-white" href="{{ route('admin.admin-user.new') }}">
                                    <button type="button" class="btn btn-round btn-sm btn-primary">
                                        <i class="ft-user-plus text-white"></i> {{ __('add_new') }}
                                    </button>
                                </a>
                            @endif
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard text-center">
                                <div class="table-responsive">
                                    <table
                                        class="table display nowrap table-striped table-bordered alt-pagination dataTables_scroll"
                                        id="indextable">
                                        <thead>
                                            <tr>
                                                <th>Sl.</th>
                                        ...
                                        <tbody>
                                            @foreach ($triggers as $row)
                                                <tr>
                                                    ...
                                                    <td>{{ $row->first_name }} {{ $row->middle_name }}
                                                        {{ $row->last_name }}</td>
                                                    <td>{{ $row->username }}</td>
                                                    ...
                                                    <td>
                                                        @if (hasAccessAbility('edit_admin_user', $roles))
                                                            <a
                                                                href="{{ route('admin.admin-user.edit', [$row->id]) }}">
                                                                <button type="button"
