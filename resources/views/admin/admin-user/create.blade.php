...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('create_admin_user') }}
    </li>
@endsection
@section('content')
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Status</label>
                                <div class="controls">
                                    {!! Form::select('status', ['1' => 'Yes', '0' => 'No'], null, [
                                        'class' => 'form-control mb-1',
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                {!! Form::select('can_login', ['1' => 'Yes', '0' => 'No'], null, [
                                    'class' => 'form-control mb-1',
                ...
                <div class="form-actions mt-10 text-center">
                    <button type="button" class="btn btn-warning mr-1">
                        <i class="ft-x"></i> <a href="{{ route('admin.admin-user') }}"> {{ __('btn_cancle') }} </a>
                    </button>
