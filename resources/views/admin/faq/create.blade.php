...
@section('title') {{ __('faq_create') }} @endsection
@section('page-name') {{ __('faq_create') }} @endsection

@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}">{{ __('admin_breadcrumb_title') }}</a>
    </li>
    <li class="breadcrumb-item active">{{ __('faq_create') }} </li>
@endsection
<?php
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group {!! $errors->has('question') ? 'error' : '' !!}">
                                        <label>{{ __('faq_question') }}<span class="text-danger">*</span></label>
                                        <div class="controls">
