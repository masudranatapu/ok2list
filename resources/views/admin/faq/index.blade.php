                    ...
                    <div class="card card-sm">
                        <div class="card-header">
                            @if (hasAccessAbility('new_faq', $roles))
                                <a class="btn btn-round btn-sm btn-primary text-white"
                                    href="{{ route('admin.faq.create') }}" title="ADD NEW PACKAGE"><i
                                        class="ft-plus text-white"></i>Add Faq</a>
                            @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (hasAccessAbility('delete_faq', $roles))
                                                            <a href="{{ route('admin.faq.delete', [$row->pk_no]) }}"
