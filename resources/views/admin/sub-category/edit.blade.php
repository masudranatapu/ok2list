...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('edit_cate') }}</li>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open([
                                'route' => ['admin.sub_category.update', $subcategory->PK_NO],
                                'method' => 'post',
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-3">
                                    <div class="form-group {!! $errors->has('category') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::select('category', $categories_combo, $subcategory->F_PRD_CATEGORY_NO, [
