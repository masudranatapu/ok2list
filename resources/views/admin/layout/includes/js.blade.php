...
<script src="{{asset('/app-assets/vendo₦/js/tables/datatable/datatables.min.js')}}"></script>
...
<!-- END: Theme JS-->
<script src="{{asset('/app-assets/vendo₦/js/forms/validation/jqBootstrapValidation.js')}}"></script>
<!-- BEGIN: Page JS-->
