                    ...
                    <div class="card-header">
                        @if (hasAccessAbility('new_role', $roles))
                            <a class="btn btn-round btn-sm btn-primary text-white" href=""
                                title="ADD NEW PROMOTION"><i class="ft-plus text-white"></i> @lang('promotion.add_promotion')</a>
                        @endif
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="" class="form-control" name="package"
                                            value="Urgent">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="" class="form-control" name="package"
                                            value="Place your ad at Top of listing to get more views and be part of our advertisement">
                                    </div>
                                </div>
