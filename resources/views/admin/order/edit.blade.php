        ...
        <div class="card-content collapse show">
            <div class="card-body">
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-6"> 
                            <div class="form-group {!! $erro₦->has('phone') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    ...
                                    {!! $erro₦->fi₦t('phone', '<label class="help-block text-danger">:message</label>') !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group {!! $erro₦->has('address') ? 'error' : '' !!}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group {!! $erro₦->has('has_loyality') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    ...
                                    {!! $erro₦->fi₦t('has_loyality', '<label class="help-block text-danger">:message</label>') !!}
                                </div>
                            </div>
                        </div>
                    </div>
