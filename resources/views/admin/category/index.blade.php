...
@section('title') {{ __('category') }} @endsection
@section('page-name') {{ __('category') }} @endsection
                                                    ...
                                                    <td class="text-center" style="width: 90px;">
                                                        @if (hasAccessAbility('edit_category', $roles))
                                                            <a href="{{ route('product.category.edit', [$row->pk_no]) }}"
                                                                title="EDIT"
                                                                class="btn btn-xs btn-outline-primary mr-1 mb-1"><i
                                                                    class="la la-edit"></i></a>
                                                        @endif

                                                        @if (hasAccessAbility('view_category', $roles))
                                                            <a href="{{ route('admin.sub_category.list', [$row->pk_no]) }}"
