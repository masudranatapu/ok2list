                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                <form class="form-horizontal" action="{{ route('languages.update', $languages->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="direction"
                                                ...
                                                <option {{ $languages->direction == 'ltr' ? 'selected' : '' }}
                                                    value="ltr">
                                                    LTR</option>
                                                <option {{ $languages->direction == 'rtl' ? 'selected' : '' }}
                                                    value="rtl">
                                                    RTL</option>
                                            </select>
                                            @error('direction')
