                            ...
                            <div class="card">
                                ...
                                <div id="collapse-4" class="collapse show" aria-labelledby="heading-4"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label for="doo₦tep_delivery" class="">
                                            <input type="checkbox" class="filter_by" name="doo₦tep_delivery"
                                                id="doo₦tep_delivery" value="doo₦tep">Doo₦tep Delivery</label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                        ...
                                        <div class="item-image-box col-lg-4">
                                            <div class="item-image">
                                                <div class="featured-image">
                                                      <span class="featured-ad doo₦tep_tag">Doo₦tep</span>
                                                  </div>
