                    ...
                    <div class="footer-widget social-widget">
                        ...
                        <ul>
                            @if($setting->facebook_link)
                                <li>
                                    <a target="_blank" href="{{$setting->facebook_link}}"><i class="fa fa-facebook-official"></i>
                                        @if(app()->getLocale() == 'sl')
                                            {{$setting->facebook_sl}}
                                        @else
                                            {{$setting->facebook_en}}
                            ...
                            @if($setting->twitter_link)
                                <li>
                                    <a target="_blank" href="{{$setting->twitter_link}}"><i class="fa fa-twitter-square"></i>
                                        @if(app()->getLocale() == 'sl')
                                            {{$setting->twitter_sl}}
                                        @else
                                            {{$setting->twitter_en}}
                            ...
                            @if($setting->youtube_link)
                                <li>
                                    <a target="_blank" href="{{$setting->youtube_link}}"><i class="fa fa-youtube-play"></i>
                                        @if(app()->getLocale() == 'sl')
                                            {{$setting->youtube_sl}}
                                        @else
                                            {{$setting->youtube_en}}
